...
| M4320 | 軸2_X升降_上位命令 | Axis2 upper command | 定位命令 | 移到上位D4410 |  |
| M4321 | 軸2_X升降_儲存盒取光罩位命令 | Axis2 storage pick command | 定位命令 | 移到D4412 |  |
| M4322 | 軸2_X升降_儲存盒放光罩位命令 | Axis2 storage place command | 定位命令 | 移到D4414 |  |
| M4323 | 軸2_X升降_檢查位取光罩位命令 | Axis2 inspection pick command | 定位命令 | 移到D4416 |  |
| M4324 | 軸2_X升降_檢查位放光罩位命令 | Axis2 inspection place command | 定位命令 | 移到D4418 |  |
| M4325 | 軸2_X升降_上機盒取光罩位命令 | Axis2 load box pick command | 定位命令 | 移到D4420 |  |
| M4326 | 軸2_X升降_上機盒放光罩位命令 | Axis2 load box place command | 定位命令 | 移到D4422 |  |
| M4327 | 軸2_X升降_BUSY | Axis2 X lift BUSY | 狀態 | U1\G3150 bit狀態 | 唯一語意：只作BUSY，不得作定位命令。 |
| M4330 | 軸2_X升降_共用真空確認位命令 | Axis2 common vacuum check position command | 定位命令 | 取片後上升約10mm真空確認 | 不可作JOG；若各站高度不同使用M4333~M4335。 |
| M4331 | 軸2_X升降_JOG-_舊點位禁用 | Axis2 legacy JOG- disabled | Deprecated | 不得正式引用 | 正式JOG-使用M4341。 |
| M4332 | 軸2_X升降_JOG+_舊點位禁用 | Axis2 legacy JOG+ disabled | Deprecated | 不得正式引用 | 正式JOG+使用M4340。 |
| M4333 | 軸2_X升降_儲存盒真空確認位命令_預留 | Axis2 storage vacuum check command spare | 預留 | 若儲存盒真空確認高度不同時啟用 |  |
| M4334 | 軸2_X升降_檢查位真空確認位命令_預留 | Axis2 inspection vacuum check command spare | 預留 | 若檢查位真空確認高度不同時啟用 |  |
| M4335 | 軸2_X升降_上機盒真空確認位命令_預留 | Axis2 load vacuum check command spare | 預留 | 若上機盒真空確認高度不同時啟用 |  |
| M4340 | 軸2_X升降_JOG+ | Axis2 jog plus | 手動調機 | HMI M6014驅動，需M6200+M6251允許 |  |
| M4341 | 軸2_X升降_JOG- | Axis2 jog minus | 手動調機 | HMI M6013驅動，需M6200+M6251允許 |  |
